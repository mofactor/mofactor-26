...
export default function ToptalBadge({ className = "left-0 top-12 origin-top-left" }: { className?: string }) {
  return (
    <a
      href="https://www.toptal.com/designers/resume/onur-oztaskiran#B6GYvY"
      target="_blank"
      rel="noopener noreferrer"
      className={`absolute z-20 hidden md:block scale-50 mix-blend-luminosity ${className}`}
    ...
    >
      ...
      >
        ...
        >
          ...
          <h3 style={{ margin: 0, fontSize: 19, fontWeight: 700, lineHeight: 1 }}>
            TOP 3% TALENT
          </h3>
          <div style={{ width: 120, height: 1, background: "#25a9ef" }} />
          <span style={{ fontSize: 16, marginBottom: -6 }}>Vetted by</span>
          <svg style={{ width: 100 }} viewBox="0 0 108 30" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
